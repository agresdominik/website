...
For extra information I have implemented a simple script to query the source country of the IP Adress. This is done easily with public apis like [ipadress.com](https://www.ipaddress.com/apis/ip-to-country-api). Althogh this is nice information to have, it is not 100% correct, as IP adresses change and on the day we query it does not have to belong to the same user 10 or more days ago when the log found it.
